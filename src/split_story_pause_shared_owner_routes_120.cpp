...
extern int UiRoute5900_7B5900(void*,int,int,int,int,int);
extern int UiRoute52A0_7B52A0(void*,int);
...
int OwnerClampSelection_A2A7BB(const PauseOwnerView120*s,int v,int row,int maxv){return Own(s)?UiRoute5900_7B5900(gUiInput_11B20C4,v,row,maxv,0,0):v;}
...
int OwnerSelection4_A2AB2F(const PauseOwnerView120*s,int v,int row,int maxv){return Own(s)?UiRoute5900_7B5900(gUiInput_11B20C4,v,row,maxv,0,0):v;}
bool OwnerHasTwoRoutes_A2AB57(const PauseOwnerView120*s){return Own(s)&&UiRoute52A0_7B52A0(gUiInput_11B20C4,1)==2;}
...
int OwnerSelectionB_A2B50E(const PauseOwnerView120*s,int v,int row,int maxv){return Own(s)?UiRoute5900_7B5900(gUiInput_11B20C4,v,row,maxv,0,0):v;}

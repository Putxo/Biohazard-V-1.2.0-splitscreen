...
extern Split* gSplit_123457C; extern int Status_C42D90(); extern int X_76A420(Split*,int); extern int XFull_76A460(Split*,int); extern int Y_76A4A0(Split*,int); extern int PanelY_76C2A0(Split*,int);

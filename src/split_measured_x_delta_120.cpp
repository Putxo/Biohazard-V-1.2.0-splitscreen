...
extern int QueryGameStatus_C42D90(void*); extern int SplitXTransform_76A420(void*,int);
...
float ApplySplitMeasuredXDelta_7DC143(float elementX,float baseX){
 ...
 if(QueryGameStatus_C42D90(session)==1)delta=float(SplitXTransform_76A420(gSplit_123457C,static_cast<int>(elementX)))-baseX;

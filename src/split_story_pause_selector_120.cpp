...
struct StoryPauseSelectView120 { std::uint8_t _00[8]; std::int32_t playerIndex; std::uint8_t _0C[0x34-0x0C]; std::int32_t state; std::int32_t previousState; std::int32_t selectedRow; std::int32_t optionCount; const std::int32_t* optionIds; std::uint8_t _48[0x58-0x48]; std::uint8_t substate; };
